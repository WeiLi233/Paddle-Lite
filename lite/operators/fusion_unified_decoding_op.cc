...
bool FusionUnifiedDecodingOp::CheckShape() const {
  return true;
}

bool FusionUnifiedDecodingOp::InferShapeImpl() const {
  return true;
}
...
bool FusionUnifiedDecodingOp::AttachImpl(const cpp::OpDesc& op_desc,
  ...
  param_.decoder_ln_bias_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("DecoderLayernormBias").front());
  param_.decoder_ln_weight_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("DecoderLayernormWeight").front());
  ...
  param_.lm_ln_bias_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("LMLayernormBias").front());
  param_.lm_ln_weight_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("LMLayernormWeight").front());
  param_.logits_mask_ = \
  ...
  param_.positional_embedding_weight_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("PositionEncEmb").front());
  param_.position_ids_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("PositionIds").front());
  param_.role_embedding_table_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Input("RoleEmbedding").front());
  param_.role_id_ = \
  ...
  param_.output_scores_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Output("OutputScores").front());
  param_.parent_ids_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Output("ParentIds").front());
  param_.sequence_length_ = \
    GetMutableVar<lite::Tensor>(scope, op_desc.Output("SequenceLength").front());
